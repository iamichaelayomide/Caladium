...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#050408] py-24 md:py-32">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_60%_at_50%_50%,rgba(170,47,137,0.28),transparent),radial-gradient(ellipse_40%_40%_at_58%_48%,rgba(94,41,146,0.18),transparent)]" />
      ...
      <div className="container relative text-center">
        ...
        <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link href="/contact">
            <Button variant="outline" size="lg" className="border-white bg-white text-[#0b0911] hover:bg-[#f5eaf5] hover:text-[#0b0911]">
